  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      ...
      <div className="flex gap-3">
        ...
        <button onClick={() => history.back()} className="flex items-center gap-2 border-2 border-gray-300 text-gray-600 px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors">
