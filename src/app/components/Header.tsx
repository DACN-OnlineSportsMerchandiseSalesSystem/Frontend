      ...
      <div className="px-4 py-3 min-h-[44px] flex items-center gap-3">
        ...
        <div className="flex items-center gap-1 ml-auto">
          ...
          {!isLoggedIn ? (
            <Link
              to="/login"
              className="flex items-center gap-1.5 px-3 py-2 text-white hover:bg-blue-600 rounded-lg transition-colors whitespace-nowrap"
            >
              <User className="w-5 h-5" />
              <span className="hidden sm:inline text-sm font-medium">Đăng ký/Đăng nhập</span>
            </Link>
          ) : (
            <div className="relative">
              <button
